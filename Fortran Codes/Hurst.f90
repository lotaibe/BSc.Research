program mymain
    ...
    USE procedures
    INTEGER pos, no_lines, iostat_value, nn, t_count
    REAL b
   ...
   t_count = 1
   open(15, file='./Patient Signals/a0080.txt')
   do i=1,2
       read(15,*)
   end do
   do
